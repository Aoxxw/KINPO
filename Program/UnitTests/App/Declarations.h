...
/*! Функция проверки равенства двух узлов(для тестирования)
\param[in] node1 - первый узел
\param[in] node2 - второй узел
\param[out] are_equal - показатель равенства узлов
*/
...
\param[in,out] number_of_iteration - текущее количество рекурсивных вызовов данной функции
...
/*! Сортирует в алфавитном порядке узлов-потомков текущего узла, если его значение – "+" или "*"
\param[in, out] current_node - текущий узел
*/
